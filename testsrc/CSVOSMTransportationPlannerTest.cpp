...
TEST(CSVOSMTransporationPlanner, PathDescriptionFailureCases)
{
    ...
    EXPECT_FALSE(PlannerWithoutBus.GetPathDescription({{CTransportationPlanner::ETransportationMode::Walk, 1},
                                                       {CTransportationPlanner::ETransportationMode::Bus, 2}},
                                                      Description));
    EXPECT_FALSE(PlannerWithoutBus.GetPathDescription({{CTransportationPlanner::ETransportationMode::Bike, 1},
    ...
    EXPECT_FALSE(Planner.GetPathDescription({{CTransportationPlanner::ETransportationMode::Walk, 1},
                                             {CTransportationPlanner::ETransportationMode::Bus, 3}},
                                            Description));
...
TEST(CSVOSMTransporationPlanner, DuplicateNamedWayReplacesLongerSegment)
{
    ...
    StreetMap->AddNode(1, 38.5, -121.70);
    StreetMap->AddNode(2, 38.5, -121.71);
    StreetMap->SetNodeLookupResponses(2, {{38.5, -121.80},
                                          {38.5, -121.71}});
    ...
    std::vector<std::string> Description;
    EXPECT_TRUE(Planner.GetPathDescription({{CTransportationPlanner::ETransportationMode::Bike, 1},
                                            {CTransportationPlanner::ETransportationMode::Bike, 2}},
                                           Description));
...
TEST(CSVOSMTransporationPlanner, PathDescriptionCorruptPublicInputs)
{
    ...
    EXPECT_FALSE(Planner.GetPathDescription({{CTransportationPlanner::ETransportationMode::Bike, 1},
                                             {CTransportationPlanner::ETransportationMode::Bike, 2},
                                             {CTransportationPlanner::ETransportationMode::Bike, 3}},
                                            Description));
    ...
    EXPECT_FALSE(PlannerWithSecondWay.GetPathDescription({{CTransportationPlanner::ETransportationMode::Bike, 1},
                                                          {CTransportationPlanner::ETransportationMode::Bike, 2},
                                                          {CTransportationPlanner::ETransportationMode::Bike, 3}},
                                                         Description));
}
