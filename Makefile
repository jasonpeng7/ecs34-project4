...
TEST_INCLUDE	= $(INCLUDE) $(GTEST_INCLUDE)
TEST_GTEST_OBJ_FILES = $(TESTOBJ_DIR)/gtest-all.o $(TESTOBJ_DIR)/gtest_main.o
TEST_GMOCK_OBJ_FILES = $(TESTOBJ_DIR)/gmock-all.o
TEST_LDFLAGS	= $(LDFLAGS) -lpthread
TEST_GMOCK_LDFLAGS = $(LDFLAGS) -lpthread
...
$(TEST_STR_TARGET): $(TEST_STR_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_STR_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_STR_TARGET)

$(TEST_STRSRC_TARGET): $(TEST_STRSRC_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_STRSRC_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_STRSRC_TARGET)

$(TEST_STRSINK_TARGET): $(TEST_STRSINK_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_STRSINK_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_STRSINK_TARGET)

$(TEST_FILESS_TARGET): $(TEST_FILESS_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_FILESS_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_FILESS_TARGET)

$(TEST_GEOUTILS_TARGET): $(TEST_GEOUTILS_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_GEOUTILS_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_GEOUTILS_TARGET)

$(TEST_DSV_TARGET): $(TEST_DSV_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_DSV_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_DSV_TARGET)

$(TEST_XML_TARGET): $(TEST_XML_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_XML_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_XML_TARGET)

$(TEST_CSVBS_TARGET): $(TEST_CSVBS_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_CSVBS_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_CSVBS_TARGET)

$(TEST_CSVBSINDEX_TARGET): $(TEST_CSVBSINDEX_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_CSVBSINDEX_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_CSVBSINDEX_TARGET)

$(TEST_OSM_TARGET): $(TEST_OSM_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_OSM_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_OSM_TARGET)

$(TEST_DPR_TARGET): $(TEST_DPR_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_DPR_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_DPR_TARGET)

$(TEST_TPCLI_TARGET): $(TEST_TPCLI_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_GMOCK_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_TPCLI_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_GMOCK_OBJ_FILES) $(TEST_GMOCK_LDFLAGS) -o $(TEST_TPCLI_TARGET)

$(TEST_DTP_TARGET): $(TEST_DTP_OBJ_FILES) $(TEST_GTEST_OBJ_FILES)
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(TEST_DTP_OBJ_FILES) $(TEST_GTEST_OBJ_FILES) $(TEST_LDFLAGS) -o $(TEST_DTP_TARGET)

$(TESTOBJ_DIR)/gtest-all.o: ./googletest/googletest/src/gtest-all.cc
	$(CXX) $(CFLAGS) $(CPPFLAGS) $(GTEST_INCLUDE) -c $< -o $@

$(TESTOBJ_DIR)/gtest_main.o: ./googletest/googletest/src/gtest_main.cc
	$(CXX) $(CFLAGS) $(CPPFLAGS) $(GTEST_INCLUDE) -c $< -o $@

$(TESTOBJ_DIR)/gmock-all.o: ./googletest/googlemock/src/gmock-all.cc
	$(CXX) $(CFLAGS) $(CPPFLAGS) $(GTEST_INCLUDE) -c $< -o $@

$(TESTOBJ_DIR)/%.o: $(TESTSRC_DIR)/%.cpp
	$(CXX) $(TEST_CFLAGS) $(TEST_CPPFLAGS) $(DEFINES) $(TEST_INCLUDE) -c $< -o $@
